  ...
  return (
    <>
      ...
      <div className="blog-post">
        ...
        <p className="blog-content">
          Huge thanks to the GDSC team for organizing such an amazing event and creating a platform for us to grow. I can’t wait for next year’s Devfest—I’m already looking forward to the new technologies, new connections, and, of course, more  moments!
        </p>
